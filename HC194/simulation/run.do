...
quietly set PROJECT_DIR "D:/project/program/QUARTUS/eda/HC194"
...
vlog -vlog01compat -work postlayout "${PROJECT_DIR}/designer/impl1/HC194_ba.v"
vlog "+incdir+${PROJECT_DIR}/stimulus" -vlog01compat -work postlayout "${PROJECT_DIR}/stimulus/testbench.v"

vsim -L proasic3 -L postlayout  -t 1ps -sdfmax /HC194_0=${PROJECT_DIR}/designer/impl1/HC194_ba.sdf postlayout.testbench
add wave /testbench/*
run 1000ns
