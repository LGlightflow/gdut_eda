...
# Fri Dec 16 19:49:54 2022

# (NEW DESIGN)

# create a new design
new_design -name "Verilog2" -family "ProASIC3"

# set default back-annotation base-name
set_defvar "BA_NAME" "Verilog2_ba"
...
set_defvar "EXPORT_STATUS_REPORT_FILENAME" "Verilog2.rpt"
...
import_source  \
-format "edif" -edif_flavor "GENERIC" -netlist_naming "VERILOG" {../../synthesis/Verilog2.edn}

# export translation of original netlist
export -format "verilog" {../../synthesis/Verilog2.v}
