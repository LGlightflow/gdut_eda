...
quietly set PROJECT_DIR "D:/project/program/QUARTUS/eda/HC85"
...
vsim -L proasic3 -L postlayout  -t 1ps -sdfmax /HC85_0=${PROJECT_DIR}/designer/impl1/HC85_ba.sdf postlayout.testbench
add wave /testbench/*
run 1000ns
