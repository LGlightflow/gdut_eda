...
# Sat Nov 12 15:53:21 2022

# (NEW DESIGN)

# create a new design
new_design -name "adder_2" -family "ProASIC3"

# set default back-annotation base-name
set_defvar "BA_NAME" "adder_2_ba"
...
set_defvar "EXPORT_STATUS_REPORT_FILENAME" "adder_2.rpt"
...
import_source  \
-format "edif" -edif_flavor "GENERIC" -netlist_naming "VERILOG" {../../synthesis/adder_2.edn}

# export translation of original netlist
export -format "verilog" {../../synthesis/adder_2.v}
